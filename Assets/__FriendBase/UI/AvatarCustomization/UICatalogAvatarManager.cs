...
public class UICatalogAvatarManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject firstTimeModal;
    ...
    void OnAvatarCardSelected(AvatarGenericCatalogItem catalogItem, UIAbstractCardController cardController)
    {
        ...
        {
            avatarCustomizationController.ChangeAvatarPart(catalogItem.ItemType, catalogItem);
        }
    }
    ...
    {
        string txtTitle = "Wait a sec! Are you sure?";
        string txtDesc = "This is your last chance to choose any item for free. After saving you can edit, but it will cost you coins/gems.";
        string txtBtnAccept = "Yes, save";
        string txtBtnDiscard = "No, keep editing";
