...
public class AvatarCustomizationController : MonoBehaviour
{
    ...
    public void ChangeAvatarPart(ItemType itemTypeToChange, AvatarGenericCatalogItem catalogItem)
    {
    ...
    void CheckForceDisableItems(ItemType itemType)
    {
    ...
    void CheckForceEnableItems(ItemType itemType)
    {
